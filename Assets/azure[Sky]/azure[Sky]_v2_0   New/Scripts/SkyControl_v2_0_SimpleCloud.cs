...
[AddComponentMenu("azure[Sky]/v2.0/Simple Cloud Control")]
[ExecuteInEditMode]
public class SkyControl_v2_0_SimpleCloud : MonoBehaviour
{
	...
	public Color sunsetEdgeColor    =  new Color(0.99f, 0.79f, 0.64f, 1.0f);
	public Color sunsetDarkColor    =  new Color(0.25f, 0.34f, 0.44f, 1.0f);
	public float sunsetCloudDensity =  1.75f;
	public Color noonEdgeColor      =  new Color(1.0f, 1.0f, 1.0f, 1.0f);
	public Color noonDarkColor      =  new Color(0.25f, 0.34f, 0.44f, 1.0f);
	public float noonCloudDensity   =  1.0f;
	public Color nightEdgeColor    =  new Color(0.10f, 0.20f, 0.32f, 1.0f);
	public Color nightDarkColor    =  new Color(0.01f, 0.03f, 0.09f, 1.0f);
	public float nightCloudDensity =  4.4f;
	...
	void SkyUpdate()
	{
		...
		//CLOUD//
		skyMat.SetTexture("_Cloud1", cloudTexture);
		skyMat.SetColor ("_sunsetEdgeColor", sunsetEdgeColor);
		skyMat.SetColor ("_sunsetDarkColor", sunsetDarkColor);
		skyMat.SetFloat ("_SunsetCloudDensity", sunsetCloudDensity);
		skyMat.SetColor ("_noonEdgeColor", noonEdgeColor);
		skyMat.SetColor ("_noonDarkColor", noonDarkColor);
		skyMat.SetFloat ("_NoonCloudDensity", noonCloudDensity);
		skyMat.SetColor ("_nightEdgeColor", nightEdgeColor);
		skyMat.SetColor ("_nightDarkColor", nightDarkColor);
		skyMat.SetFloat ("_NightCloudDensity", nightCloudDensity);
		skyMat.SetFloat ("_MoonBright", moonBrightIntensity);
		skyMat.SetFloat ("_MoonBrightRange", moonBrightRange);
		skyMat.SetFloat ("_CloudExtinction", cloudExtinction);
		skyMat.SetFloat ("_AlphaSaturation", alphaSaturation);
