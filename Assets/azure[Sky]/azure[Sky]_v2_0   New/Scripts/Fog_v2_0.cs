...
[AddComponentMenu("azure[Sky]/v2.0/Fog Scattering")]
public class Fog_v2_0 : MonoBehaviour
{
	...
	void OnRenderImage(RenderTexture source, RenderTexture destination) 
	{
		...
		if (fogMaterial==null)
		{
			...
			#if UNITY_EDITOR
			Debug.Log("Warning. Apply the <b>Fog Material</b> to ('Fog Scattering v2_0 Image Effect') script in Inspector");
			#endif
			return;
		}
		//-------------------------------------------------------------------------------------------------------
