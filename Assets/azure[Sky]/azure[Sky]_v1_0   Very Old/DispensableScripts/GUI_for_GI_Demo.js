...
//     target.NormalFogDen=GUI.HorizontalSlider(Rect (165, 275, 100, 10), target.NormalFogDen, 0.0, 1.0);
     ...
     GUI.Label (Rect (90, 200, 100, 20), "<b>Moon Settings</b>");
     // Moon Shadow X Axis
     GUI.Label (Rect (10, 220, 150, 20), "Moon Shadow X-Axis");
     target.MoonShadowX=GUI.HorizontalSlider(Rect (165, 225, 100, 10), target.MoonShadowX, 1.0, -1.0);
     // Moon Shadow Y Axis
     GUI.Label (Rect (10, 245, 150, 20), "Moon Shadow Y-Axis");
     target.MoonShadowY=GUI.HorizontalSlider(Rect (165, 250, 100, 10), target.MoonShadowY, 1.0, -1.0);
     // Moon Shadow Intensity
     GUI.Label (Rect (10, 270, 150, 20), "Moon Shadow Intensity");
     target.MoonShadowIntensity=GUI.HorizontalSlider(Rect (165, 275, 100, 10), target.MoonShadowIntensity, 0.0, 1.0);
    ...
    if (GUI.Button(Rect(75,310,120,25),"Standard Settings"))
    {
        target.SunIntensity=500.0;
        target.MoonIntensity=10.0;
        target.DayLuminance=1.143;
