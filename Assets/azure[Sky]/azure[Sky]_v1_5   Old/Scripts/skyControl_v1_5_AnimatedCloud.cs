...
[AddComponentMenu("azure[Sky]/v1.5/Sky Control Animated Cloud")]
[ExecuteInEditMode]
public class skyControl_v1_5_AnimatedCloud : MonoBehaviour
{
...
//-------------------------------------------------------------------------------------------------------
	...
	public  float nightTopCloud  =  0.0f;
...
//-------------------------------------------------------------------------------------------------------
	...
	void SkyUpdate()
	{
		...
		skyMat.SetFloat ("nightTopCloud", nightTopCloud);
